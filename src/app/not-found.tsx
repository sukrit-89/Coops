...
export default function NotFound() {
  return (
    <div className="relative w-full min-h-[100svh] bg-black overflow-x-hidden select-none">
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      <div
        aria-label="LGPSM"
        className="absolute left-1/2 -translate-x-1/2 z-10 top-[32px] sm:top-[80px] scale-[0.75] sm:scale-100 origin-top flex items-center w-[233px] h-[40px]"
      >
        {/* Mark */}
        <svg
          viewBox="0 0 54 40"
        ...
        <svg
          ...
          fill="none"
          className="w-[164.311px] h-[40px] ml-[14px] shrink-0"
          aria-hidden="true"
        >
          <path
      ...
      <main className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center text-center w-[min(100%-40px,360px)] sm:w-[483px] gap-[28px] sm:gap-[44px]">
        {/* 404 Heading */}
        <h1
          style={{
          ...
          className="text-center h-auto min-h-0 pb-2 text-[clamp(140px,52vw,200px)] sm:text-[295.751px] tracking-[-0.09em] sm:tracking-[-24.6459px]"
        >
          404
        </h1>
        ...
        <p
          ...
          className="text-white text-center w-full text-[clamp(16px,4.5vw,20px)] sm:text-[24px] tracking-[-1.3px] sm:tracking-[-2px]"
        >
